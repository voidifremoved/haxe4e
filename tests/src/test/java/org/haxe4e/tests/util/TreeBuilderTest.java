...
class TreeBuilderTest {
    ...
    void testTreeBuilder() {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> mb.put("foo", mb));
        ...
        assertThat(((java.util.Map<?, ?>) mb.getMap().get("e"))).containsKey("computed");

        mb.compute("new_computed", b -> b.put("nested", true));
        assertThat(((java.util.Map<?, ?>) mb.getMap().get("new_computed"))).containsKey("nested");
        ...
        assertThat(mb.getMap()).doesNotContainKeys("null_map", "null_builder", "null_list", "null_bool", "null_number",
                "null_string");
        ...
        assertThat(((java.util.Map<?, ?>) mb.getMap().get("e"))).doesNotContainKeys("null_bool", "null_list",
                "null_number", "null_string");
    }
}
